...
int monthly_rate(double hourly_rate, double discount) {
    ...
    // discount.
    double monthly_rate_before_discount = (hourly_rate * 8) * 22;
    double full_discount = monthly_rate_before_discount * discount/100;
    return ceil(monthly_rate_before_discount - full_discount);
}
...
int days_in_budget(int budget, double hourly_rate, double discount) {
    ...
    double full_budget = budget + budget * discount/100;
    double daily_rate = hourly_rate * 8;
    return floor(full_budget/daily_rate);
}
